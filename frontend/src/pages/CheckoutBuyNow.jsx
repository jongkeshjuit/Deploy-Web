...
import { createCheckoutSession, clearCheckout } from "../redux/slices/checkoutSlice";
                    ...
                    {formData.paymentMethod === "bank_transfer" && (
                        <div className="space-y-4 mb-6 p-4 border border-gray-300 rounded-lg bg-gray-50">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <div className="text-sm">
                                        <span className="font-semibold">Ngân hàng:</span> {BANK_INFO.bankName}
                                    </div>
                                    <div className="text-sm">
                                        <span className="font-semibold">Số tài khoản:</span> {BANK_INFO.accountNumber}
                                    </div>
                                    <div className="text-sm">
                                        <span className="font-semibold">Tên tài khoản:</span> {BANK_INFO.accountName}
                                    </div>
                                    <div className="text-sm">
                                    ...
                                    <div className="text-sm">
                                        ...
                                        <div className="font-mono text-xs bg-white p-2 border rounded mt-1">
                                            {generateOrderCode()} {userInfo?.phone || formData.phone || ""}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded p-3 mt-4">
                                <div className="text-sm text-yellow-800">
                                    ...
                                    <ul className="list-disc list-inside space-y-1 text-xs">
                                        ...
                                        <li>Liên hệ hotline: {BANK_INFO.contact.hotline} nếu cần hỗ trợ</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                {paymentCheckResult && (
                                    <div
                                        className={`mt-2 text-sm ${paymentCheckResult.success ? "text-green-600" : "text-red-600"
                                            }`}
                                    >
                ...
                <div className="flex-1 border p-4 sm:p-6 md:p-8 bg-white max-w-full md:max-w-md mt-8 md:mt-0">
                    ...
                    <div className="text-xs text-gray-500 mb-2">
                        ...
                        <span className="float-right">
                            {Math.round((getTotalPrice() + 50000) / 11).toLocaleString("vi-VN")} VND
                        </span>
                    </div>
                    <div className="border-t border-black my-2"></div>
