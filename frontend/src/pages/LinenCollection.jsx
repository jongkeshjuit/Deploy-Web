...
const LinenCollection = () => {
  const linenProducts = [
    ...
    },
    {
      ...
      description:
        "Quần ống rộng linen cao cấp, phong cách hiện đại và thoải mái",
      details: {
    ...
    <div className="container mx-auto px-[50px] py-8">
      ...
      <div className="max-w-2xl mx-auto mb-12 text-center">
        <p className="text-gray-600 text-lg">
          Khám phá bộ sưu tập linen cao cấp của chúng tôi, được chế tác từ những
          sợi tự nhiên tốt nhất. Mỗi sản phẩm được thiết kế để mang lại sự thoải
          mái và sang trọng cho phong cách của bạn.
        </p>
      </div>
        ...
        {linenProducts.map((product) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <p className="text-gray-600 mt-6 flex-grow text-sm">
                {product.description}
              </p>
            </div>
          </Link>
