...
const EditCollection = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEdit) {
                // Chỉ cập nhật name, description, bannerUrl
                const payload = {
                ...
                await axios.put(`${API_URL}/api/collections/${collectionData.id}`, payload, {
                    headers: { Authorization: `Bearer ${userToken}` },
                });
    ...
    if (loading) return <div className="text-center mt-10">Đang tải bộ sưu tập...</div>;
    ...
    return (
        <div className="w-full mx-auto p-6">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-xl mx-auto">
                ...
                {!isEdit ? (
                    <div>
                        <label className="block font-medium text-lg">ID bộ sưu tập (phải là duy nhất)</label>
                        <input
                            type="text"
                            name="id"
                ...
                <div>
                    ...
                    {collectionData.image && (
                        <div className="mb-2">
                            ...
                            <button
                                type="button"
                                onClick={() => setCollectionData(prev => ({ ...prev, image: "" }))}
