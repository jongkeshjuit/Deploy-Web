            ...
            <div className='max-w-6xl mx-auto bg-white rounded-lg p-8'>
                <div className='flex flex-col md:flex-row gap-8'>
                    ...
                    <div className='md:w-1/2'>
                        <div className='mb-4'>
                            <img src={mainImage || product.images[0]?.url} alt="Main Product" className='w-full h-full object-cover rounded-md' />
                        </div>
                    </div>
                    {/* mobile thumbnail */}
                    ...
                    <div className='md:w-1/2 md:ml-10'>
                            ...
                            <div className='flex gap-2 mt-2'>
                                {product.colors.map((color) => (
                                    <button
                                        ...
                                        className={`w-6 h-6 rounded-full border cursor-pointer ${selectedColor === color ? 'border-2 border-black' : 'border-gray-300'}`}
                                        style={{
                        ...
                        <div className='mb-6 flex flex-col items-start gap-2'>
                            ...
                            <div className='flex items-center bg-gray-100 rounded-full'>
                                ...
                                <span className='px-5 py-2 bg-gray-100 text-lg'>{quantity}</span>
                                <button
                        ...
                        <button
                            ...
                            className={`bg-black text-white px-6 py-2 rounded w-full ${isButtonDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-800'}`}>
