...
const FilterSidebar = () => {
  ...
  return (
    <div className='p-4'>
      ...
      {/* Kích thước */}
      <div className='mb-6'>
        <label className='block font-medium text-gray-700 mb-3'>Kích thước</label>
        <div className='flex flex-wrap gap-2'>
          {size.map((s) => (
            <button
              key={s}
        ...
        <div className='space-y-2'>
          {price.map((p) => (
            <label key={p.value} className='flex items-center cursor-pointer group'>
              ...
              />
              <span className='ml-2 text-gray-600 group-hover:text-gray-900'>{p.name}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      {/* Chất liệu */}
      <div className='mb-6'>
        <label className='block font-medium text-gray-700 mb-3'>Chất liệu</label>
        <div className='space-y-2'>
          {materials.map((m) => (
            <label key={m.value} className='flex items-center cursor-pointer group'>
              ...
              />
              <span className='ml-2 text-gray-600 group-hover:text-gray-900'>{m.name}</span>
            </label>
          ))}
        </div>
      </div>
