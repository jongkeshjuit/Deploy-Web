...
import { useOrders } from '../profile/OrderContext'

const CollectionSection = ({ sex, title, mediaUrl, mediaType = 'image', items = [], link }) => {
    // Ví dụ: lấy orders từ context nếu cần
    ...
    return (
        <div className="flex flex-col justify-center gap-6 mt-6">
            ...
            <div className="container mx-auto px-7 sm:px-4 md:px-6 lg:px-32">
                ...
                {/* Ví dụ: hiển thị số lượng orders từ context nếu muốn */}
                {orders && (
                    <div className="text-xs text-gray-500 mt-4 text-center">
                        Tổng số đơn hàng hiện có: {orders.length}
                    </div>
                )}
            </div>
